...
public class Mandamentos9 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mandamentos9);
        ...
        setaesquerda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(Mandamentos9.this, Mandamentos8.class);
        ...
        setadireita.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(Mandamentos9.this, Mandamentos10.class);
                startActivity(intent1);
            }
        });
